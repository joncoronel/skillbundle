      ...
      {data.map((d, i) => {
        ...
        return (
          <motion.rect
            ...
            fill={fill}
            height={barHeight}
            // Already-mounted bars (post enter-animation) have no initial
            // opacity to tween from; `initial={false}` adopts the animate value
            // immediately and avoids motion's "animate from undefined" warning.
            initial={false}
